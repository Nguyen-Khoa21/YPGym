...
export default function InvoicesScreen() {
  ...
  return <Screen refreshing={invoices.isRefetching} onRefresh={() => void invoices.refetch()}><PageTop title="Invoices" onBack={() => router.back()} /><Heading title="Payment records" detail="Confirmed simulated payments and immutable invoice details." />
