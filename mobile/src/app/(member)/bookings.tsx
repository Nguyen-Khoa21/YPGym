...
export default function BookingsScreen() {
  ...
  return <Screen refreshing={bookings.isRefetching} onRefresh={() => void bookings.refetch()}><PageTop title="My Bookings" onBack={() => router.back()} /><Heading title="Your class queue" detail={bookings.data ? `Cancellations close ${bookings.data.cancellation_window_hours} hours before class start.` : undefined} />
