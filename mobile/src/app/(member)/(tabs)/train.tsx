...
import { exerciseImage, muscles, type Exercise, type ExercisePage, type Muscle } from '@/lib/training';
...
export default function TrainScreen() {
  ...
  return <Screen refreshing={catalogue.isRefetching} onRefresh={() => void catalogue.refetch()}><Brand /><Heading eyebrow="YPTrain · exercise guide" title="Find your next exercise" detail="Browse upper and lower body exercises from the shared YPGym catalogue." />
