...
import { exerciseImage, muscleLabels, muscles, type Exercise, type ExercisePage, type Muscle, type WorkoutToday } from '@/lib/training';
...
export default function TrainScreen() {
  ...
  return <Screen refreshing={catalogue.isRefetching || today.isRefetching} onRefresh={() => { void queryClient.invalidateQueries({ queryKey: ['training'] }); }}><Brand /><Heading eyebrow="YPTrain · exercise guide" title="Find your next exercise" detail="Browse upper and lower body exercises from the shared YPGym catalogue." />
