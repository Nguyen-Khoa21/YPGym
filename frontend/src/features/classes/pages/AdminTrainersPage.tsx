...
export function AdminTrainersPage() {
  ...
  function openNew() { form.reset(emptyTrainer); setEditing("new"); }
  function openEdit(trainer: Trainer) { form.reset({ display_name: trainer.display_name, specialty: trainer.specialty ?? "", availability_summary: trainer.availability_summary ?? "", bio: trainer.bio ?? "" }); setEditing(trainer); }
