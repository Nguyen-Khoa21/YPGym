...
export function NotificationPreferencesPage() {
  ...
  const form = useForm<NotificationPreference>({ defaultValues: { email_enabled: true, in_app_enabled: true, expiry_reminders_enabled: true, class_reminders_enabled: true, broadcasts_enabled: true } });
