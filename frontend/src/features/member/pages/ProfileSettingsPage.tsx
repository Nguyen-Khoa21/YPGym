...
const profileRows = [
  { label: "Personal information", detail: "Name, phone and protected email", icon: CircleUserRound, connected: true },
  { label: "Account security", detail: "Password changes are connected", icon: LockKeyhole, connected: true },
  { label: "Personalization profile", detail: "Planned after Day 20", icon: Palette, connected: false },
  { label: "Notification preferences", detail: "Planned after Day 20", icon: Bell, connected: false },
];
