...
- **Scale story:** Pagination, indexed filters, Redis projections, bounded analytics, and the planned isolated load run provide the basis for a 1,000-user test; measured limits must be added before a quantitative scalability claim.
